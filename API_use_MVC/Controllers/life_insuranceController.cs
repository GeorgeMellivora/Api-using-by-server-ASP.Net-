...
namespace API_use_MVC.Controllers
{
    public class life_insuranceController : Controller
    {
        ...
        {
            string TargetUri = "https://ins-info.ib.gov.tw/opendata/json-06161610.aspx";
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var data = JsonConvert.DeserializeObject<List<life_insuranceData>>(jsonResult); // 解析 JSON 資料到 List<life_insuranceData>
